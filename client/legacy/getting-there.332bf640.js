...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(iframe, "class", "gmap svelte-emz4sh");
      ...
      add_location(iframe, file, 57, 2, 800);
      attr_dev(div0, "class", "container");
      add_location(div0, file, 56, 0, 774);
      attr_dev(h20, "class", "subtitle");
      add_location(h20, file, 81, 12, 1614);
      add_location(br0, file, 83, 12, 1700);
      add_location(br1, file, 85, 12, 1745);
      add_location(br2, file, 87, 12, 1809);
      add_location(br3, file, 89, 12, 1850);
      add_location(br4, file, 91, 12, 1897);
      attr_dev(div1, "class", "column");
      add_location(div1, file, 80, 10, 1581);
      attr_dev(h21, "class", "subtitle");
      add_location(h21, file, 96, 12, 1966);
      attr_dev(td0, "class", "svelte-emz4sh");
      add_location(td0, file, 100, 16, 2062);
      attr_dev(td1, "class", "svelte-emz4sh");
      add_location(td1, file, 101, 16, 2115);
      add_location(tr0, file, 99, 14, 2041);
      attr_dev(td2, "class", "svelte-emz4sh");
      add_location(td2, file, 104, 16, 2194);
      attr_dev(td3, "class", "svelte-emz4sh");
      add_location(td3, file, 105, 16, 2247);
      add_location(tr1, file, 103, 14, 2173);
      attr_dev(td4, "class", "svelte-emz4sh");
      add_location(td4, file, 108, 16, 2327);
      attr_dev(td5, "class", "svelte-emz4sh");
      add_location(td5, file, 109, 16, 2364);
      add_location(tr2, file, 107, 14, 2306);
      attr_dev(table, "class", "svelte-emz4sh");
      add_location(table, file, 98, 12, 2019);
      add_location(p0, file, 113, 12, 2440);
      attr_dev(a0, "class", "rounded-link col-2 bg-col-7");
      attr_dev(a0, "href", REGISTER_URL);
      add_location(a0, file, 115, 14, 2520);
      add_location(div2, file, 114, 12, 2500);
      attr_dev(div3, "class", "column");
      add_location(div3, file, 94, 10, 1932);
      attr_dev(div4, "class", "columns");
      add_location(div4, file, 78, 8, 1548);
      attr_dev(div5, "class", "container is-widescreen");
      add_location(div5, file, 76, 6, 1501);
      attr_dev(section0, "class", "section bg-col-2 garden-block svelte-emz4sh");
      add_location(section0, file, 75, 4, 1447);
      attr_dev(h22, "class", "subtitle");
      add_location(h22, file, 124, 8, 2762);
      add_location(p1, file, 125, 8, 2834);
      attr_dev(a1, "class", "rounded-link bg-col-3 col-7");
      attr_dev(a1, "href", REGISTER_URL);
      add_location(a1, file, 130, 10, 3157);
      add_location(div6, file, 129, 8, 3141);
      attr_dev(div7, "class", "container align-center svelte-emz4sh");
      add_location(div7, file, 123, 6, 2717);
      attr_dev(section1, "class", "section bg-col-7");
      add_location(section1, file, 122, 4, 2676);
      attr_dev(h1, "class", "title");
      add_location(h1, file, 137, 8, 3365);
      add_location(p2, file, 143, 10, 3632);
      attr_dev(div8, "class", "container align-center svelte-emz4sh");
      add_location(div8, file, 136, 6, 3320);
      if (img.src !== (img_src_value = "img/handsanitizer.png")) attr_dev(img, "src", img_src_value);
      add_location(img, file, 157, 12, 4115);
      attr_dev(div9, "class", "column");
      add_location(div9, file, 156, 10, 4082);
      add_location(li0, file, 163, 16, 4268);
      add_location(li1, file, 167, 16, 4454);
      add_location(li2, file, 168, 16, 4534);
      add_location(li3, file, 172, 16, 4689);
      add_location(li4, file, 173, 16, 4773);
      add_location(li5, file, 177, 16, 4958);
      add_location(li6, file, 178, 16, 5034);
      add_location(ul, file, 162, 14, 4247);
      attr_dev(div10, "class", "content");
      add_location(div10, file, 161, 12, 4211);
      attr_dev(div11, "class", "column");
      add_location(div11, file, 160, 10, 4178);
      attr_dev(div12, "class", "columns");
      add_location(div12, file, 154, 9, 4049);
      attr_dev(div13, "class", "content bg-col-8 garden-block sanitize-content svelte-emz4sh");
      add_location(div13, file, 152, 8, 3978);
      attr_dev(div14, "class", "container ");
      add_location(div14, file, 150, 6, 3944);
      attr_dev(section2, "class", "section is-white");
      add_location(section2, file, 135, 6, 3279);
      attr_dev(h23, "class", "subtitle");
      add_location(h23, file, 195, 14, 5473);
      add_location(p3, file, 196, 14, 5529);
      add_location(p4, file, 200, 14, 5677);
      add_location(strong, file, 210, 16, 6075);
      add_location(p5, file, 207, 14, 5898);
      attr_dev(a2, "href", "https://www.gold.ac.uk/find-us/places/st-james-hatcham-building/");
      add_location(a2, file, 215, 16, 6230);
      add_location(p6, file, 213, 14, 6172);
      attr_dev(h24, "class", "subtitle");
      add_location(h24, file, 222, 14, 6420);
      add_location(p7, file, 223, 14, 6477);
      add_location(p8, file, 227, 14, 6651);
      attr_dev(div15, "class", "content");
      add_location(div15, file, 194, 12, 5437);
      attr_dev(div16, "class", "container align-center svelte-emz4sh");
      add_location(div16, file, 192, 6, 5387);
      attr_dev(section3, "class", "section is-white");
      add_location(section3, file, 191, 4, 5346);
      attr_dev(div17, "class", "content");
      add_location(div17, file, 73, 4, 1420);
      attr_dev(div18, "class", "container");
      add_location(div18, file, 72, 2, 1392);
      attr_dev(section4, "class", "section bg-col-7 getting-there-section svelte-emz4sh");
      add_location(section4, file, 71, 0, 1333);
    },
