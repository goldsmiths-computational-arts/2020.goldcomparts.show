...
var file = "src/routes/physical.svelte";
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      var head_nodes = query_selector_all("[data-svelte=\"svelte-6z0ryy\"]", document.head);
      ...
      section1 = claim_element(section5_nodes, "SECTION", {
        class: true,
        id: true
      });
      ...
      img = claim_element(section5_nodes, "IMG", {
        class: true,
        src: true,
        alt: true
      });
      t31 = claim_space(section5_nodes);
      section2 = claim_element(section5_nodes, "SECTION", {
        class: true
      });
      ...
      section3 = claim_element(section5_nodes, "SECTION", {
        class: true,
        id: true
      });
      ...
      section4 = claim_element(section5_nodes, "SECTION", {
        class: true,
        id: true
      });
...
function instance($$self, $$props) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Physical> was created with unknown prop '".concat(key, "'"));
  });
...
var Physical = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(Physical, _SvelteComponentDev);

  var _super = _createSuper(Physical);
