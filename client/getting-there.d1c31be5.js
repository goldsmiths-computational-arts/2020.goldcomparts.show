import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, b as validate_slots, f as space, e as element, t as text, w as query_selector_all, l as detach_dev, h as claim_space, g as claim_element, j as children, k as claim_text, m as attr_dev, C as set_style, n as add_location, o as insert_dev, p as append_dev, r as noop } from './client.4e401bf2.js';
import { R as REGISTER_URL } from './constants.e85bc00e.js';

/* src/routes/getting-there.svelte generated by Svelte v3.24.0 */
const file = "src/routes/getting-there.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-zfd5wn\"]", document.head);
			...
			div18 = claim_element(section4_nodes, "DIV", { class: true });
			...
			a1 = claim_element(div6_nodes, "A", { class: true, href: true });
			...
			img = claim_element(div9_nodes, "IMG", { src: true });
			...
			section3 = claim_element(div17_nodes, "SECTION", { class: true });
			var section3_nodes = children(section3);
			div16 = claim_element(section3_nodes, "DIV", { class: true });
			var div16_nodes = children(div16);
			div15 = claim_element(div16_nodes, "DIV", { class: true });
			var div15_nodes = children(div15);
			h23 = claim_element(div15_nodes, "H2", { class: true });
			...
			a2 = claim_element(p6_nodes, "A", { href: true });
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Getting_there> was created with unknown prop '${key}'`);
	});

	let { $$slots = {}, $$scope } = $$props;
	validate_slots("Getting_there", $$slots, []);
	$$self.$capture_state = () => ({ REGISTER_URL });
	return [];
}

class Getting_there extends SvelteComponentDev {
	constructor(options) {
		super(options);
